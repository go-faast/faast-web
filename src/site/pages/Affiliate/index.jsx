    ...
    <div>
      <div className='text-dark' style={{ backgroundColor: '#323540' }}>
        ...
        <div style={{ backgroundColor: '#fff' }}>
          <Container>
            <Row className={classNames(style.whyUseFast, 'text-center py-5 px-0 mx-2 justify-content-center')}>
              <Col xs='12'>
                  ...
                  {features.map((f,i) => (
                    <Col style={{ borderRadius: 4, boxShadow: 'rgba(200, 216, 236, 0.5) 0px 5px 11px 1px' }} key={i} xs='12' md='5' className='text-left mb-4 px-3 py-4 mr-4'>
                      <h2 style={{ fontWeight: 600 }}>
                        <img className='mr-2' width='34' height='34' src={f.icon} /> {f.heading}
                      </h2> 
                      <p className='mt-3' style={{ lineHeight: 1.7, color: '#657586' }}>{f.description}</p>
                    </Col>
                  ))}
                </Row>
              </Col>
