...
class PriceChartController extends Component {
...
PriceChartController.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(PriceChartController)
