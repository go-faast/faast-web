...
export default compose(
  ...
  withHandlers({
    ...
    validateAmount: ({ capacityBalance }) => validator.all(
      validator.required(),
      validator.greaterThan(0, 'Withdrawal amount must be greater than 0.'),
  ...
  return (
    <Modal
      ...
      <ModalHeader close={<span className='cursor-pointer' onClick={toggle}>close</span>} tag='h4' toggle={toggle} className={cardHeader}>
        Withdrawal from your Capacity Address
      </ModalHeader>
          ...
          <Col sm='12'>
            <Form onSubmit={handleSubmit}>
              <div className='mt-0 mb-3'>
                <ReduxFormField 
                  name='amount'
                  label={<p className={classNames('font-weight-bold m-0', text)}>Amount to withdrawal (BTC)</p>}
              ...
              >
                Withdrawal Capacity To Exchange
              </Button>
            </Form>
          </Col>
