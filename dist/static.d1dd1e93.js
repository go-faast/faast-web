...
var _padLeft = __webpack_require__(27);
...
.then(function () {
  return idbNotReadyQueue.reduce(function (prev, message) {
    ...
    return console.error('Failed to push ' + idbNotReadyQueue.length + ' log messages to IDB', e);
  });
});
    ...
    if (data && data.length > 0) {
      data = data.map(function (item) {
        ...
        if ((0, _lodash.isObject)(item)) {
          var strObj = JSON.stringify(item);
...
var _faastLogo64x = __webpack_require__(67);
...
var _bn = __webpack_require__(28);
...
var _IconCarousel = __webpack_require__(65);
...
var _asset = __webpack_require__(39);
...
var _propTypes3 = __webpack_require__(41);
...
var _Faast = __webpack_require__(45);
...
exports.createAffiliateSignature = exports.getAffiliateSwaps = exports.affiliateRegister = exports.initiateAffiliateWithdrawal = exports.getAffiliateAccount = exports.getAffiliateBalance = exports.getAffiliateSwapPayouts = exports.getAffiliateStats = exports.provideSwapDepositTx = exports.fetchOrders = exports.createNewOrder = exports.refreshSwap = exports.fetchSwap = exports.formatOrderResult = exports.fetchRestrictionsByIp = exports.fetchPairData = exports.fetchPriceChart = exports.fetchAssetPrices = exports.fetchAssetPrice = undefined;
...
var siteUrl = _Config2.default.siteUrl,
    ...
    affiliateSettings = _Config2.default.affiliateSettings;
var getAffiliateSettings = function getAffiliateSettings() {
    var affiliateId = (0, _storage.sessionStorageGet)('affiliateId');
    return __assign({}, affiliateSettings, { affiliate_id: typeof affiliateId === 'string' ? affiliateId : affiliateSettings.affiliate_id });
};
...
var formatOrderResult = exports.formatOrderResult = function formatOrderResult(r) {
    return {
        orderId: r.swap_id,
...
var createNewOrder = exports.createNewOrder = function createNewOrder(_a) {
    var sendSymbol = _a.sendSymbol,
        ...
        userId = _a.userId;
    return (0, _fetch.fetchPost)(apiUrl + "/api/v2/public/swap", __assign({ user_id: userId, deposit_amount: sendAmount, deposit_currency: sendSymbol, withdrawal_address: receiveAddress, withdrawal_currency: receiveSymbol, refund_address: refundAddress }, getAffiliateSettings())).then(formatOrderResult).catch(function (e) {
        _Log2.default.error(e);
...
var getAffiliateStats = exports.getAffiliateStats = function getAffiliateStats(id, key) {
    var nonce = String(Date.now());
    var signature = createAffiliateSignature(undefined, key, nonce);
    return (0, _fetch.fetchGet)(apiUrl + "/api/v2/public/affiliate/stats", null, {
        headers: {
            'affiliate-id': id,
            nonce: nonce,
            signature: signature
...
var getAffiliateSwapPayouts = exports.getAffiliateSwapPayouts = function getAffiliateSwapPayouts(id, key) {
    var nonce = String(Date.now());
    var signature = createAffiliateSignature(undefined, key, nonce);
    return (0, _fetch.fetchGet)(apiUrl + "/api/v2/public/affiliate/withdrawals", undefined, {
        headers: {
            'affiliate-id': id,
            nonce: nonce,
            signature: signature
...
var getAffiliateBalance = exports.getAffiliateBalance = function getAffiliateBalance(id, key) {
    var nonce = String(Date.now());
    var signature = createAffiliateSignature(undefined, key, nonce);
    return (0, _fetch.fetchGet)(apiUrl + "/api/v2/public/affiliate/balance", undefined, {
        headers: {
            'affiliate-id': id,
            nonce: nonce,
            signature: signature
...
var getAffiliateAccount = exports.getAffiliateAccount = function getAffiliateAccount(id, key) {
    var nonce = String(Date.now());
    var signature = createAffiliateSignature(undefined, key, nonce);
    return (0, _fetch.fetchGet)(apiUrl + "/api/v2/public/affiliate/account", null, {
        headers: {
            'affiliate-id': id,
            nonce: nonce,
            signature: signature
...
var initiateAffiliateWithdrawal = exports.initiateAffiliateWithdrawal = function initiateAffiliateWithdrawal(withdrawalAddress, id, key) {
    var requestJSON = {
        withdrawal_address: withdrawalAddress
    };
    var nonce = String(Date.now());
    var signature = createAffiliateSignature(JSON.stringify(requestJSON), key, nonce);
    return (0, _fetch.fetchPost)(apiUrl + "/api/v2/public/affiliate/withdraw", requestJSON, undefined, { headers: {
            'affiliate-id': id,
            nonce: nonce,
            signature: signature
        }
...
var affiliateRegister = exports.affiliateRegister = function affiliateRegister(id, address, email) {
    return (0, _fetch.fetchPost)(apiUrl + "/api/v2/public/affiliate/register", {
        affiliate_id: id,
...
var getAffiliateSwaps = exports.getAffiliateSwaps = function getAffiliateSwaps(id, i) {
    if (i === void 0) {
        i = 1;
    }
    return (0, _fetch.fetchGet)(apiUrl + "/api/v2/public/swaps", { affiliate_id: id, limit: 100, page: i }).then(function (swaps) {
        return swaps;
    }).catch(function (e) {
        _Log2.default.error(e);
        throw e;
...
var createAffiliateSignature = exports.createAffiliateSignature = function createAffiliateSignature(requestJSON, secret, nonce) {
    var updateString = requestJSON ? nonce + requestJSON : nonce;
    return _crypto2.default.createHmac('sha256', secret).update(updateString, 'utf8').digest('hex');
};
exports.default = {
    ...
    getAffiliateSwapPayouts: getAffiliateSwapPayouts,
    initiateAffiliateWithdrawal: initiateAffiliateWithdrawal,
    affiliateRegister: affiliateRegister,
    getAffiliateBalance: getAffiliateBalance,
    getAffiliateAccount: getAffiliateAccount,
    getAffiliateSwaps: getAffiliateSwaps,
    formatOrderResult: formatOrderResult
};
...
var _txFees = __webpack_require__(113);
...
var _swapIcon = __webpack_require__(42);
...
var _reactHotLoader = __webpack_require__(55);
...
var t_1 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/dylan/dev/ba/faast-portfolio/build/site/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 47)), (0, _importCss3.default)('src/site/pages/Terms', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_2 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/dylan/dev/ba/faast-portfolio/build/site/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 48)), (0, _importCss3.default)('src/site/pages/Privacy', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_3 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/dylan/dev/ba/faast-portfolio/build/site/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 49)), (0, _importCss3.default)('src/site/pages/Pricing', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_4 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/dylan/dev/ba/faast-portfolio/build/site/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 50)), (0, _importCss3.default)('src/site/pages/404', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var _CoinIcon = __webpack_require__(38);
...
var _Pkg = __webpack_require__(85);

var _Pkg2 = _interopRequireDefault(_Pkg);

var _helpers = __webpack_require__(3);

var _idbWrapper = __webpack_require__(86);
...
var IDBStore = typeof window !== 'undefined' ? _idbWrapper2.default : function () {
  return {
    put: function put(data, cb) {
      return cb('');
    },
...
var _crossFetch = __webpack_require__(100);
    ...
    var doFetchJson = function doFetchJson() {
        return Promise.resolve().then(function () {
            ...
            var performFetch = function performFetch() {
                return (0, _crossFetch2.default)(fullPath, { method: method, headers: headers, body: bodyString }).then(function (response) {
                    try {
...
var _asset = __webpack_require__(119);
...
//# sourceMappingURL=static.d1dd1e93.js.map