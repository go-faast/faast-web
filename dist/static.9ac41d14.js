...
var getAffiliateSwapPayouts = exports.getAffiliateSwapPayouts = function getAffiliateSwapPayouts(id, key) {
    var nonce = String(Date.now());
    var signature = createAffiliateSignature(undefined, key, nonce);
    return (0, _fetch.fetchGet)(apiUrl + "/api/v2/public/affiliate/payouts", { affiliate_payment_address: '33WKJWf2iyJHUaRjoHmF7x4rKnENPHC9G8' }, {
        headers: {
            'affiliate-id': id,
            nonce: nonce,
            signature: signature
...
var getAffiliateBalance = exports.getAffiliateBalance = function getAffiliateBalance(id, key) {
    var nonce = String(Date.now());
    var signature = createAffiliateSignature(undefined, key, nonce);
    return (0, _fetch.fetchGet)(apiUrl + "/api/v2/public/affiliate/balance", { affiliate_payment_address: '33WKJWf2iyJHUaRjoHmF7x4rKnENPHC9G8' }, {
        headers: {
            'affiliate-id': id,
            nonce: nonce,
            signature: signature
...
//# sourceMappingURL=static.9ac41d14.js.map